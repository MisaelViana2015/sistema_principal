...
const getRiskColor = (score: number, count: number) => {
    if (count === 0 || score === 0) return 'bg-blue-100 dark:bg-blue-300'; // Azul fraquinho (Sem risco)
    ...
    return (
        <Card className="p-6">
            ...
            <div className="flex gap-4 mt-6 text-xs text-gray-500 items-center flex-wrap">
                ...
                <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-sm bg-blue-100 dark:bg-blue-300"></div> Sem risco (0)</div>
