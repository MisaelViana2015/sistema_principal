...
import { Car, AlertCircle, CheckCircle, Wrench, Gauge, Plus, Disc, X, Save } from "lucide-react";
    ...
    return (
        <div style={s.container}>
            <div style={s.header}>
                ...
                <button style={s.addButton} onClick={() => setIsModalOpen(true)}>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl w-full max-w-md p-6 shadow-2xl">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Novo Veículo</h2>
