    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (result.success && result.user) {
                // Update context state immediately to allow ProtectedRoute to pass
                // We cast to any because the login response is a subset of Driver (no password)
    ...
    return (
        <>
            ...
            <div className="login-container">
                ...
                <div className="version-tag">{SYSTEM_VERSION}</div>

                <div className="box" onClick={() => setIsExpanded(true)}>
                    <div className="loginBox">
                        <div className="LoginTile">
                            <h2 className="text-4xl font-black tracking-widest uppercase mb-2" style={{
                                color: '#45f3ff',
                                textShadow: '0 0 5px rgba(69, 243, 255, 0.8), 0 0 15px rgba(69, 243, 255, 0.4)'
                            }}>
                                LOGIN
                            </h2>
                        </div>
